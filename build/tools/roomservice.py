...
spark_manifest = ".repo/manifests/snippets/spark.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    sparkm = load_manifest(spark_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(sparkm, repo_path) != None:
             existing_m_project = exists_in_tree(sparkm, repo_path)
