...
ALARM_PATH := vendor/spark/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/spark/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/spark/prebuilt/common/media/audio/ringtones
